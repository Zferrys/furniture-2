...
<div class="cart-main-area pt-100px pb-100px">
    <div class="container">
        ...
        <div class="pro-pagination-style text-center mb-md-30px mb-lm-30px mt-6" data-aos="fade-up">
            <ul>
                <li><a href="manage/furnManage?action=page&pageNo=1">首页</a></li>
                <c:choose>
                ...
                <c:if test="${requestScope.page.pageNo > 1}">
                    <li><a href="manage/furnManage?action=page&pageNo=${requestScope.page.pageNo-1}">上一页</a></li>
                </c:if>
                <c:forEach begin="${begin}" end="${end}" var="i">
                    <c:if test="${i == requestScope.page.pageNo}">
                        <li><a href="manage/furnManage?action=page&pageNo=${i}" class="active">${i}</a></li>
                    </c:if>
                    <c:if test="${i != requestScope.page.pageNo}">
                        <li><a href="manage/furnManage?action=page&pageNo=${i}">${i}</a></li>
                    </c:if>
                </c:forEach>
                <c:if test="${requestScope.page.pageNo < requestScope.page.pageTotalCount}">
                    <li><a href="manage/furnManage?action=page&pageNo=${requestScope.page.pageNo+1}">下一页</a></li>
                </c:if>
                <li><a href="manage/furnManage?action=page&pageNo=${requestScope.page.pageTotalCount}">末页</a></li>
