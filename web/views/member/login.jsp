        ...
        $(function () {
            ...
            $("#code").blur(function (){
                ...
                $.getJSON("member", {
                    ...
                    function (data) {
                        if (data.codeIsExist){
                            $("span.codeVerity").text("验证码正确");
                        }else {
                            $("span.codeVerity").text("验证码错误");
                        }
                    });
            })
            ...
            $("#sub-btn").click(function () {
                ...
                //alert(usernameVal);
                var usernamePattern = /^\w{6,9}$/;
                if (!usernamePattern.test(usernameVal)) {
                    //console.log(1111);
                    $(".errorMsg").text("用户名必须是6-9位的字母数字下划线");
                    return false;
                }
                var passwordVal = $("#password").val();
                var passwordPattern = /^\w{6,9}$/;
                if (!passwordPattern.test(passwordVal)) {
                    $(".errorMsg").text("密码必须是6-9位的字母数字下划线");
                    return false;
                }
            ...
            $("#loginbutton").click(function () {
                ...
                if (!usernamePattern.test(username)) {
                    $(".errorLoginMsg").text("用户名格式错误");
                    return false;
                }
                var passwordPattern = /^\w{6,9}$/;
                if (!passwordPattern.test(password)) {
                    $(".errorLoginMsg").text("密码格式错误");
                    return false;
                }
            })
            ...
            <div class="col-lg-7 col-md-12 ml-auto mr-auto">
                <div class="login-register-wrapper">
                    <div class="login-register-tab-list nav">
                        ...
                        <a data-bs-toggle="tab" href="#lg2" id="tab_register">
                            <h4>会员注册</h4>
                        </a>
                    </div>
